  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden text-[#1F1617] font-sans selection:bg-[#4A0E17] selection:text-[#FAF0E4]">
      ...
      <main className="relative z-10 w-full max-w-[430px] mx-auto px-3 sm:px-4 min-h-screen pt-8 pb-16">
        ...
        {/* Island Cards 4A (Haldi - 05:30 PM) & 4B (Barat - 09:30 PM with GPS Pin) */}
        <EventCard />
        ...
        <motion.footer
          ...
          className="relative p-5 sm:p-7 rounded-t-[50px] sm:rounded-t-[60px] rounded-b-3xl bg-white/95 backdrop-blur-sm border-[1.5px] border-[#D4AF37]/50 shadow-[0_18px_45px_rgba(74,14,23,0.08)] text-center overflow-hidden"
        >
